...
public class Rect {
    //ada 4 variable utama yang menetukan titik sudut persegi panjang
    ...
    //* construvtor dengan panjang dan lebar dimulai dair kordinal 0,0 */
   ...
   /** method untuk memerikasa apa satu titik didalam persegi panjang */
    public boolean isInside(int x, int y){
        return ((x >= x1)&& (x <= x2)&& (y >= y1)&& (y <= y2)); }
    
    /** method untuk menggabungkan (union) persegi panjang */
